...
export default function SuppliersTransactionDetails() {
    ...
    useEffect(()=>{
    if(supplierModalId){
        axios.get(`http://localhost:8080/transaction/supplier`,{
        'headers' : {
            'Authorization' : token,
        ...
        <Modal open={open} onClose={()=>setOpen(false)} className="focus:outline-none">
            <div className="flex flex-col justify-center h-screen">
                ...
                <div className="bg-secondary-300 rounded-lg text-background m-10 border-2 w-1/2 px-4 pb-6">
                    ...
                    <SupplierTransactionStock open={open} setOpen={setOpen} transactionsId={transactionsId} setTransactionsId={setTransactionsId} data={supplierTransactions} />
