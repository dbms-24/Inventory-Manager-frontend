...
export default function CustomerTransactionStock({open, setOpen , transactionId, setTransactionId, data}) {
                ...
                <div className="bg-secondary-300 rounded-lg text-background m-10 border-2 w-1/2 px-4 pb-6">
                    ...
                    <TableContainer component={Paper}>
                        ...
                        <TableHead>
                            ...
                            <TableCell align="right">Dress Details</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            ...
                            <TableRow
                                ...
                                <TableCell align="right">{data.stockDressDescription.dressDetails.name}</TableCell>
                            </TableRow>
                            ))}
                        </TableBody>
                        </Table>
